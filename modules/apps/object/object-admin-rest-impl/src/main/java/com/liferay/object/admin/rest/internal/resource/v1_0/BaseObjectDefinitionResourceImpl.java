...
public abstract class BaseObjectDefinitionResourceImpl
	...
	public ObjectDefinition patchObjectDefinition(
		...
		if (objectDefinition.getEnableObjectDefinitionMapping() != null) {
			existingObjectDefinition.setEnableObjectDefinitionMapping(
