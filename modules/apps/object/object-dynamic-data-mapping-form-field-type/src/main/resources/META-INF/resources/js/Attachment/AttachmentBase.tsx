...
export default function AttachmentBase({
	...
	const isDepotFiles = fileSource === 'depotFiles';

	const isDocumentsAndMedia = fileSource === 'documentsAndMedia';

	const isUserComputer = fileSource === 'userComputer';

	const isUserComputerDepotUpload = fileSource === 'userComputerToDepotFiles';
				...
				{!readOnly && (
					<ClayButton
						...
						onClick={() => {
							...
							else if (isUserComputer || hasLibraryStorage) {
