...
/**
 * Wired in the Card until the headless-cmp endpoint (LPD-93362) is available. A
 * project id selects a scenario; any real (numeric) id falls back to the sample
 * partial-coverage matrix.
 */
