...
export default function MultipleFilesUploadModalContent({
	...
	/**
	 * Attaches a freshly uploaded document to the task or project the upload
	 * started from. A failure leaves the document in place but unlinked, so the
	 * error is surfaced rather than folded into the upload result: the related
	 * assets list would otherwise come back without the file and no explanation.
	 */
