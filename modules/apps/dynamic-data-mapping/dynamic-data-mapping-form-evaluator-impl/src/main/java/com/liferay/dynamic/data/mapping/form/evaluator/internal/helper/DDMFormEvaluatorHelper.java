...
public class DDMFormEvaluatorHelper {
	...
	private boolean _isFieldEmpty(
		...
		if (GetterUtil.getBoolean(
			...
			DDMFormFieldValue localizedDDMFormFieldValue =
				new DDMFormFieldValue();

			localizedDDMFormFieldValue.setName(ddmFormFieldValue.getName());
			...
			localizedDDMFormFieldValue.setValue(
