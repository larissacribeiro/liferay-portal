...
test.describe('Manage object entries through View Object Entries', () => {
	test('can add an entry with all object fields', async ({
		...
		await viewObjectEntriesPage.fillDateEntry('05/14/2024');
		await viewObjectEntriesPage.fillObjectEntry('decimal', '12.34');
		await viewObjectEntriesPage.fillObjectEntry('integer', '1234');
		await viewObjectEntriesPage.fillObjectEntry(
			'longInteger',
			'1122334455'
		);
		await viewObjectEntriesPage.selectDropdownItem('picklist', 'item1');
		await viewObjectEntriesPage.fillObjectEntry('precisionDecimal', '1.5');
		await viewObjectEntriesPage.fillRichTextEntry(
